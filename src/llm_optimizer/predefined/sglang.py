...
SGLANG_SERVER_CONFIGS: ConfigsDict = {
    ...
    "constrained_json_whitespace_pattern": ArgConfig[str](name="constrained_json_whitespace_pattern"),
    ...
    "enable_request_time_stats_logging": ArgConfig[bool](name="enable_request_time_stats_logging"),
    ...
    "speculative_accept_threshold_single": ArgConfig[float](name="speculative_accept_threshold_single"),
    "speculative_accept_threshold_acc": ArgConfig[float](name="speculative_accept_threshold_acc"),
    ...
    "enable_flashinfer_allreduce_fusion": ArgConfig[bool](name="enable_flashinfer_allreduce_fusion"),
    ...
    "eplb_rebalance_num_iterations": ArgConfig[int](name="eplb_rebalance_num_iterations"),
    "eplb_rebalance_layers_per_chunk": ArgConfig[int](name="eplb_rebalance_layers_per_chunk"),
    "expert_distribution_recorder_mode": ArgConfig[str](name="expert_distribution_recorder_mode"),
    "expert_distribution_recorder_buffer_size": ArgConfig[int](name="expert_distribution_recorder_buffer_size"),
    "enable_expert_distribution_metrics": ArgConfig[bool](name="enable_expert_distribution_metrics"),
    ...
    "enable_tokenizer_batch_encode": ArgConfig[bool](name="enable_tokenizer_batch_encode"),
    ...
    "triton_attention_reduce_in_fp32": ArgConfig[bool](name="triton_attention_reduce_in_fp32"),
    "triton_attention_num_kv_splits": ArgConfig[int](name="triton_attention_num_kv_splits"),
    ...
    "enable_custom_logit_processor": ArgConfig[bool](name="enable_custom_logit_processor"),
    ...
    "flashinfer_mla_disable_ragged": ArgConfig[bool](name="flashinfer_mla_disable_ragged"),
    "disable_shared_experts_fusion": ArgConfig[bool](name="disable_shared_experts_fusion"),
    "disable_chunked_prefix_cache": ArgConfig[bool](name="disable_chunked_prefix_cache"),
    "disable_fast_image_processor": ArgConfig[bool](name="disable_fast_image_processor"),
    ...
    # --- Debug tensor dumps ---
    "debug_tensor_dump_output_folder": ArgConfig[str](name="debug_tensor_dump_output_folder"),
    ...
    "debug_tensor_dump_prefill_only": ArgConfig[bool](name="debug_tensor_dump_prefill_only"),

    # --- PD disaggregation ---
    "disaggregation_mode": ArgConfig[str](name="disaggregation_mode"),
    "disaggregation_transfer_backend": ArgConfig[str](name="disaggregation_transfer_backend"),
    "disaggregation_bootstrap_port": ArgConfig[int](name="disaggregation_bootstrap_port"),
